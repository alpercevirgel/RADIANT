---
title: "2_FlowSOM_clustering_RADIANT.V1.0_usr"
...
# down sampling 
  min_cells = 1000 # indicate the minimum amount of cells to include from each file (files with less cells will be excluded from analysis)
