---
title: "1_Data_Preprocessing_RADIANT.V0.2_usr"
...
# importing custom functions
  RMD = "Pre_processing"
  source(file.path(wd, cellType, "00 RADIANT files", "RADIANT_dependencies_usr_v0.2.R"))
...
# a = raw files, b = transformed files, c = cleaned and transformed files 
  ...
  write.ArcsinH.Mapping = FALSE # set to TRUE if you want a panel file template to be written automatically
...
### ADJUSTABLE VARIABLES ###
  ...
  write_files = FALSE # set to TRUE if you want to write Mapping Files.
  writePanel = FALSE # set to TRUE if you want to write the Panel file
  
  cleaningMethod = "None" # select the method to be used for data cleaning. Options are: 'PeacoQC',  or 'None'.
  transformationMethod = "ArcSinH" # select method to be used for transformation. Options are: 'Logicle', "ArcSinH", or 'None'.

  customFileNameVar = NA # string specifying a parameter (other than 'TUBE NAME', '$FIL', or '$TBNM") 
  
  multComp = FALSE # set to TRUE if you have multiple compensation matrices
  multRef = FALSE # set to TRUE if you have multiple reference files
  
  #markers_of_interest = c("FSC-A", "SSC-A", "CD8_IgG",  "CXCR5", "CXCR3", "CD95", "CD45RA", "CCR6", "PD1", "CD3_IgD", "HLA_DR", "CD27", "CCR4","CCR10", "CD38", "CD25") 
  markers_of_interest = c("FSC-A", "SSC-A", "FITC", "RB613", "RB705", "RB744", "RB780", "APC", "SR718", "APC_Fire750", "BUV395", "BUV496", "BUV563", "BUV615", "BUV737", "BUV805", "BV421", "BV510", "BV605", "BV650", "BV711", "BV750", "BV786", "RY586", "RY610", "PE_Cy7") 
...
### ADJUSTABLE VARIABLES ###
  ...
  writeMeta = FALSE #set to TRUE if you want a metadata file template to be written automatically, set to FALSE if already done
...
### ADJUSTABLE VARIABLES ###
  ...
  TCs = FALSE # set to TRUE if the data contains technical controls
...
### ADJUSTABLE VARIABLES ###
  ...
  crossEntropyTest = FALSE # set to FALSE if you don't want to run it, or have run it before
...
"UV6-740_35-A" = "CD45RA",
"UV7-810_40-A" = "CCR6",
"Violet1-450_50-A" = "PD1",
"Violet4-610_20-A" = "CD3_IgD",
"Violet5-670_30-A" = "HLA_DR",
"Violet6-710_50-A" = "CD27",
"Violet7-750_30-A" = "CCR4",
"YG1-586_15-A" = "CCR10",
"YG2-610_20-A" = "CD38",
"YG4-780_60-A" = "CD25"
  )
...
### ADJUSTABLE VARIABLES ###
  ...
  performCN = FALSE # set TRUE if you want to perform cytonorm, FALSE if not.
  ...
  nCellsCN = 10000 #set the total amount of cells you want to train the CytoNorm model on. Default 5000
  
  ydimCN = 10 #set the amount of SOMnodes in the y dimension. Default 10
  xdimCN = 10 #set the amount of SOMnodes in the x dimension. Default 10
  
  nClustersCN = 10 #set the amount of metaclusters you want to use for CytoNorm. Default 10. Must be within range of testCVcluster
...
### ADJUSTABLE VARIABLES ###
  ...
  nClustersCN = 15 # set the amount of metaclusters you want to use for CytoNorm. Based on CVS values (see manual).
...
# only change these variables if you know what they do, and why you want to change them  
  nCellsCN = 10000 #set the total amount of cells you want to train the CytoNorm model on. Default 10000
